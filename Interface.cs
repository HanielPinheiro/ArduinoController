    ...
    public partial class Interface : MaterialForm
    {
        ...
        private void btnConnect_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                _control = new Control(_parameters);
        ...
        {
            MessageBox.Show($"{errorMessage} - Exception message: {e.Message}", "Erro!", MessageBoxButtons.OK, MessageBoxIcon.Error); ;
        }

        private void Interface_FormClosed(object sender, FormClosedEventArgs e)
        {
            try { _control!.Dispose(); } catch { /* Ignorado */ }
        }
    }
}